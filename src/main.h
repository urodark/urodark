...
static const uint256 hashGenesisBlock("0x00000d72e23ed0f906f02872219f53d137de56d8723d4f28c50afd29445b290b");
static const uint256 hashGenesisBlockTestNet("0x0007218d41480caed63a3253de4f4af398f7a45dbe7ff7e1b97671755f516558");

inline int64 PastDrift(int64 nTime)   { return nTime - 15 * 60; } // up to 15 minutes from the past
inline int64 FutureDrift(int64 nTime) { return nTime + 15 * 60; } // up to 15 minutes from the future
...
int64 GetProofOfWorkReward(int nHeight, unsigned int nBits, int64 nFees=0);
int64 GetProofOfStakeReward(int nHeight, int64 nCoinAge, unsigned int nBits, unsigned int nTime, bool bCoinYearOnly=false);
...
public:
    ...
    {
        // Protocol switch to support p2pool at urodark block #9689
        ...
        // Before urodark block #9689 - old protocol
