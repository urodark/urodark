...
const string strMessageMagic = "UroDark Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in UroDark
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (IsProofOfStake())
    {
        ...
        // UroDark: check proof-of-stake block signature
    ...
    else
    {
        ...
        if(!fTestNet && fCheckSig)
        {
            ...
            // UroDark: check proof-of-work block signature
...
// urodark: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "UroDark", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "A rocket contracted by NASA bursts into flames seconds after liftoff";
        CTransaction txNew;
        txNew.nTime = 1414594531;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1414594531;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 344098 : 719;
        ...
        assert(block.hashMerkleRoot == uint256("0x2b8a951f3891c906cceed0cfa63d0fc404b89ad390b9cdcd52183ba5ff5df251"));
...
unsigned char pchMessageStart[4] = { 0xcb, 0xe8, 0xe9, 0xe1 };
