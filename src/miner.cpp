...
// Copyright (c) 2013 The UroDark developers
...
CBlock* CreateNewBlock(CWallet* pwallet, bool fProofOfStake)
{
    ...
    int64 nFees = 0;
    {
        ...
        if (!fProofOfStake)
        {
            ...
            pblock->vtx[0].vout[0].nValue = GetProofOfWorkReward(pindexPrev->nHeight+1, pblock->nBits, fProtocol048 ? nFees : 0);
        }
